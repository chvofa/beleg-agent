    ...
    def run(self):
        ...
        menu = pystray.Menu(
            ...
            pystray.MenuItem("Abgleich", pystray.Menu(
                ...
                pystray.MenuItem("Daueraufträge erfassen", self.on_dauerauftraege),
                pystray.Menu.SEPARATOR,
                pystray.MenuItem("Abgleich-Ordner öffnen", self.on_open_abgleich),
                pystray.MenuItem("Daueraufträge-Ordner öffnen", self.on_open_dauerauftraege),
            )),
            pystray.Menu.SEPARATOR,
            pystray.MenuItem("Inbox öffnen", self.on_open_inbox),
            pystray.MenuItem("Excel öffnen", self.on_open_excel),
            pystray.MenuItem("Log öffnen", self.on_open_log),
            pystray.Menu.SEPARATOR,
